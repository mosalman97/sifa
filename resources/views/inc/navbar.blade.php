      ...
      <!-- <div id="navtop" class="col-xs-8"> -->
        <nav  aria-label="breadcrumb ">
          <ol class="breadcrumb"  id="myTopnav">
            <li class="breadcrumb-item {{Request::is('/') ? 'activeNav' :''}}" aria-current="page"><a href="/">Home</a></li>
            ...
            <li class="breadcrumb-item {{Request::is('about') ? 'activeNav' :''}}"><a href="/about">Nominal Form</a></li>
            <li class="breadcrumb-item {{Request::is('contact') ? 'activeNav' :''}}"><a href="/contact">Contact</a></li>
            <li class="breadcrumb-item {{Request::is('gallery') ? 'activeNav' :''}}"><a href="/gallery">Gallery</a></li>
